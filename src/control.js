...
const CONTROL_COMMANDS = new Set([
  "edit", "progress", "react", "reply", "send", "send-file", "send-stack", "send-voice", "status", "stop", "thread-new",
]);
    ...
    socket.on("data", (chunk) => {
      ...
      while (!settled) {
        ...
        if (phase === "ready") {
          ...
          phase = "result";
          if (command === "send-file" || command === "send-stack" || command === "send-voice") socket.setTimeout(0);
